...
import { CircularBuffer } from '../node_modules/mthb-circular-buffer/lib/CircularBuffer';
...
export class ScrollView {
    ...
    private scrollBarThumbMinY: number;
    private scrollBarThumbMaxY: number;
    private scrollBarPosMaxY: number;
    private pageY:number;
    private touchStartY: number;

    private hasScrollBarX: boolean;
    ...
    private scrollBarThumbMinX: number;
    private scrollBarThumbMaxX: number;
    private scrollBarPosMaxX: number;
